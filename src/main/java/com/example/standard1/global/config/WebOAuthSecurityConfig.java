package com.example.standard1.global.config;
...
import com.example.standard1.global.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import com.example.standard1.global.config.oauth.OAuth2SuccessHandler;
import com.example.standard1.global.config.oauth.OAuth2UserCustomService;
        ...
        return http
                ...
                .authorizeRequests(auth -> auth
                        .requestMatchers(new AntPathRequestMatcher("/api/token"),
                                ...
                                new AntPathRequestMatcher("/api/v1/users/refresh")
                        ).permitAll()
